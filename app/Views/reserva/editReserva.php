            ...
            <form action="<?= site_url('reserva/update/' . $reserva['id_reserva']) ?>" method="post">
                    ...
                    <select name="fk_id_lab" id="fk_id_lab" class="form-control" required>
                        ...
                        <?php foreach ($laboratorios as $laboratorio): ?>
                            <option value="<?= $laboratorio['id_lab'] ?>" 
                                <?= ($laboratorio['id_lab'] == $reserva['fk_id_lab']) ? 'selected' : '' ?>>
                    ...
                    <select name="fk_id_doc" id="fk_id_doc" class="form-control" required>
                        ...
                        <?php foreach ($docentes as $docente): ?>
                            <option value="<?= $docente['id_doc'] ?>" 
                                <?= ($docente['id_doc'] == $reserva['fk_id_doc']) ? 'selected' : '' ?>>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="fecha_reserva" id="fecha_reserva" 
                           value="<?= $reserva['fecha_reserva'] ?>" class="form-control" required>
                </div>

                <div class="form-group">
                    <label for="hora_inicio_reserva">Hora Inicio</label>
                    <input type="time" name="hora_inicio_reserva" id="hora_inicio_reserva" 
                           value="<?= $reserva['hora_inicio_reserva'] ?>" class="form-control" required>
                </div>

                <div class="form-group">
                    <label for="hora_fin_reserva">Hora Fin</label>
                    <input type="time" name="hora_fin_reserva" id="hora_fin_reserva" 
                           value="<?= $reserva['hora_fin_reserva'] ?>" class="form-control" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="motivo_reserva" id="motivo_reserva" class="form-control" required><?= $reserva['motivo_reserva'] ?></textarea>
                </div>
